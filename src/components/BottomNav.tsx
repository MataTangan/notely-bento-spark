...
import { Home, ListChecks, CalendarDays, Wrench, CreditCard, BarChart } from "lucide-react";
...
const tabs = [
  ...
  { to: "/analytics", label: "Stats", icon: BarChart },
  { to: "/billing", label: "Premium", icon: CreditCard },
] as const;
